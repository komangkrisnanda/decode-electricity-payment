<?php
    ...
    $queryCheck = $conn->query("SELECT tbpelanggan.*, tbtagihan.*, tbtarif.* FROM tbtagihan INNER JOIN tbpelanggan ON tbtagihan.NoPelanggan = tbpelanggan.NoPelanggan INNER JOIN tbtarif ON tbtarif.KodeTarif = tbpelanggan.KodeTarif WHERE tbtagihan.KodeTagihan = $code AND tbpelanggan.NoPelanggan = $username");
...
<body style="text-align: center">
    ...
    <?php
        if($data['Status'] == "Belum"){
            ?>
                <p>Please pay the bill into our bank account : XXX-XXXXXXXX </p>
            <?php
        }
